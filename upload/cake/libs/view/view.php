 ...
 */
	function _paths($plugin = null, $cached = true) {
		...
		//***** PHPPA Render Paths adjustment ******//
		$template=Configure::read('App.theme');
		$dir=Configure::read('App.dir');
		array_unshift($viewPaths, $_SERVER['DOCUMENT_ROOT'].'/'.$dir.'/admin/', $_SERVER['DOCUMENT_ROOT'].'/'.$dir.'/'.$template.'/');
		//***** PHPPA Render Paths adjustment ******//
