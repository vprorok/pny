...
class libero extends openinviter_base
	...
	public function login($user, $pass)
	{
		...
		$form_action="http://m.mailbeta.libero.it/doLogin";		
		$post_elements=array(
							"username"=>$user,
							"pwd"=>$pass,
							"azione"=>"Entra"
		...
		$this->login_ok="http://m.mailbeta.libero.it/address_book.jsp";		
		return true;
	}
	...
	public function getMyContacts()
		...
		if (preg_match_all("#name\=\"address\" value\=\"(.+)\"#siU",$res,$matches))
