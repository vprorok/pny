...
if ($registration['registered'] == '0') {
	...
	if ($lookforupdate) {
		...
		if($last >  $registration['currentupdate']) {
			echo "<div class=\"announce\">".$strings['UpdateAvailable']."<br><a href=\"./admin_stats.php?mode=update&lang=$lang&todo=testupdate&version=$last\">".$strings['InstallUpdate']."</a></div>\n";
		}
...
if ($n<0) {
	$str = "<table class=\"basic\"><tr><td><IMG src=\"img/phptraffica/ System/decr.gif\" width=\"10\" height=\"14\" align=\"left\" border=\"0\" alt=\"$n$txt\"></td><td>".format_float($n)."%</td></tr></table>";
} else {
	$str = "<table class=\"basic\"><tr><td><IMG src=\"img/phptraffica/System/incr.gif\" width=\"10\" height=\"14\" align=\"left\" border=\"0\" alt=\"$n$txt\"></td><td>+".format_float($n)."%</td></tr></table>";
}
return $str;
}
...
$tdw = $maxwidth +5;
$txtPage = "<table class=\"basic\"><tr><td width=\"${tdw}px\"><img src=\"img/phptraffica/System/bar.gif\" alt=\"$text\" width=\"$width\" height=\"10\" border=\"1\"></td><td>$text</td></tr></table>";
return $txtPage;
}
...
$txtPage = "<table class=\"basic\"><tr><td><a href=\"$url\" class=\"img\"><IMG src=\"img/phptraffica/System/up.gif\" alt=\"$namelink\" title=\"$namelink\" width=\"9\" height=\"9\" border=\"0\"></a></td><td>$name</td></tr></table>";
return $txtPage;
}
...
$txtPage = "<table class=\"basic\"><tr><td><a href=\"$url&amp;order=asc$extra\" class=\"img\"><IMG src=\"img/phptraffica/System/up.gif\" alt=\"$namelink\" title=\"$namelink\" width=\"9\" height=\"9\" border=\"0\"></a><a href=\"$url&amp;order=desc$extra\" class=\"img\"><IMG src=\"img/phptraffica/System/down.gif\" alt=\"$namelink\" title=\"$namelink\" width=\"9\" height=\"9\" border=\"0\"></a></td><td>$name</td></tr></table>";
return $txtPage;
}

function linksUpDown($url, $namelink, $extra = "") {
$txtPage = "<a href=\"$url&amp;order=asc$extra\" class=\"img\"><IMG src=\"img/phptraffica/System/up.gif\" alt=\"$namelink\" title=\"$namelink\" width=\"9\" height=\"9\" border=\"0\"></a><a href=\"$url&amp;order=desc$extra\" class=\"img\"><IMG src=\"img/phptraffica/System/down.gif\" alt=\"$namelink\" title=\"$namelink\" width=\"9\" height=\"9\" border=\"0\"></a>";
return $txtPage;
}
...
function simplePageLink($c, $table, $sid, $lang, $id, $short=1) {
	...
	return "<a href=\"admin_stats.php?mode=stats&amp;sid=$sid&amp;show=page&amp;pageid=$id&amp;lang=$lang\" title=\"".$strings['Generalstatsfor']." $name\">$page</a>";
}
...
// <ul>
// <li>- <a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=page&amp;pageid=$pageid&amp;lang=$lang\">".$strings['generalstats']."</a></li>
// <li>- <a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=key&amp;pageid=$pageid&amp;lang=$lang\">".$strings['searchenginestats']."</a></li>
// <li>- <a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=ref&amp;pageid=$pageid&amp;lang=$lang\">".$strings['referrerstats']."</a></li>
// <li>- <a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=pathdesign&amp;pathid=$pageid&amp;lang=$lang\">".$strings['pathanalysis']."</a></li>
// </ul></div>";
// 	$str = "<div name=\"pagelink\" class=\"pagelink\" id=\"pagelink\"><span>$pagename$divlink</span></div>";
	$str = "<a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=page&amp;pageid=$pageid&amp;lang=$lang\" title=\"".$strings['Generalstatsfor']." $pagename\">$pagename</a>";
	return $str;
}
