...
if ($phpTrafficA == "Admin") {
	...
	echo "<div align=\"center\"><form><form action=\"".$_SERVER['PHP_SELF']."\" method=\"post\"><input type=\"submit\" name=\"submit\" value=\"".$strings['removecookie']." $str\"><input type=\"hidden\" name=\"mode\" value=\"removecookie\"><input type=\"hidden\" name=\"lang\" value=\"$lang\"></form></div>";
} else {
