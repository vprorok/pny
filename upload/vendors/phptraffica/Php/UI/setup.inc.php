...
echo "<form action=\"./admin_stats.php\" method=\"post\">
<table>
<tr class=\"toprow\">
...
while ($bar=each($sites)) {
	...
	if (countpages($c,$table)>0) {
		...
		echo "<tr><td valign=\"middle\"><form action=\"admin_stats.php\" method=\"post\">";
...
<tr><td>".$strings['OSlist']."<a href=\"javascript:help('oslist')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td class=\"padv\"><textarea cols=\"60\" rows=\"15\" name=\"os_id\">
$config[os_list]
</textarea></td>
...
<tr><td>".$strings['Browserlist']."<a href=\"javascript:help('wblist')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td class=\"padv\"><textarea cols=\"60\" rows=\"15\" name=\"wb_id\">
$config[browser_list]
</textarea></td></tr>
</table>
</form>\n";
...
<tr class=\"title\"><td colspan=\"3\">".$strings['Configuration']."</td></tr>
<tr><td>".$strings['Searchengines']."<a href=\"javascript:help('selist')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td class=\"padv\"><textarea cols=\"60\" rows=\"15\" name=\"se_id\">
...
<tr><td>".$strings['Refererblacklist']."<a href=\"javascript:help('blist')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td class=\"padv\"><textarea cols=\"60\" rows=\"15\" name=\"bl_id\">
$config[blacklist]
</textarea></td></tr>  
</table>
</form>\n";
...
<tr><td>".$strings['SearchEnginesAreReferrers']."<a href=\"javascript:help('sereferrers')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td class=\"padv\" width=\"15%\"><select name=\"serefs\">";
if ($config['seref']) {
...
<tr><td>".$strings['VisitCutOffTime']."<a href=\"javascript:help('visitcutoff')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td class=\"padv\" width=\"15%\">
...
<tr><td>".$strings['URLTrimFactorLong']."<a href=\"javascript:help('URLTrimFactor')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td class=\"padv\" width=\"15%\">
...
<tr><td>".$strings['referrerNewDurationLong']."<a href=\"javascript:help('referrerNewDuration')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td class=\"padv\" width=\"15%\">
...
<tr><td>".$strings['doAutoCleanRKIP']."<a href=\"javascript:help('autoCleanRKIP')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td class=\"padv\" width=\"15%\">
...
<tr><td>".$strings['doAutoCleanAccess']."<a href=\"javascript:help('autoCleanAccess')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td class=\"padv\" width=\"15%\">
<select name=\"autoclean\">";
...
<tr class=\"caption\"><td>".$strings['Domain']."</td><td>".$strings['Table']."</td><td>ID</td><td>".$strings['Public']."<a href=\"javascript:help('public')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></a></td><td>".$strings['TrimURL']."<a href=\"javascript:help('trim')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td>".$strings['Countbots']."<a href=\"javascript:help('countbots')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td>".$strings['Counter']."<a href=\"javascript:help('counter')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td>".$strings['Time']."</td><td>".$strings['timediff']."<a href=\"javascript:help('timediff')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td>&nbsp;</td></tr>\n";
while ($bar=each($sites)) {
	$id = $bar[0];
	$table = $bar[1]['table'];
	$site = $bar[1]['site'];
	...
	$tabletxt = $table;
	if ($DEMO) $tabletxt = "****";
	echo "<form name=\"site$id\" action=\"./admin_stats.php\" method=\"post\">";
...
<tr><td>".$strings['Domainaddress']."<a href=\"javascript:help('domain')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td colspan=\"3\" class=\"padv\"><input size=\"40\" name=\"domain\" value=\"\"></td>
...
<tr><td>".$strings['Tablename']."<a href=\"javascript:help('table')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td colspan=\"3\" class=\"padv\"><input size=\"40\" name=\"table\" value=\"\"></td></tr>
<tr><td class=\"padv\" colspan=\"4\">
<table class=\"basic\" width=\"100%\"><tr><td>".$strings['Public']."<a href=\"javascript:help('public')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td><select name=\"public\"><option value=\"1\" selected>".$strings['Public']."</option><option value=\"0\">".$strings['Private']."</option></select></td><td>".$strings['TrimURL']."<a href=\"javascript:help('trim')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td><select name=\"trim\"><option value=\"1\" selected>".$strings['Yes']."</option><option value=\"0\">".$strings['No']."</option></select></td><td>".$strings['Countbots']."<a href=\"javascript:help('countbots')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td><select name=\"crawler\"><option value=\"1\" selected>".$strings['Yes']."</option><option value=\"0\">".$strings['No']."</option></select></td><td>".$strings['Counter']."<a href=\"javascript:help('counter')\" class=\"/img/phptraffica\"> <IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></td><td><select name=\"counter\"><option value=\"1\" selected>".$strings['Yes']."</option><option value=\"0\" selected>".$strings['No']."</option></select></td></tr></table></td></tr>
<tr><td class=\"padv\">".$strings['timediff']." (".$strings['hours'].") <a href=\"javascript:help('timediff')\" class=\"/img/phptraffica\"><IMG src=\"/img/phptraffica/System/help.png\" width=\"12\" height=\"12\" align=\"top\" border=\"0\" alt=\"".$strings['Helpme']."\" title=\"".$strings['Helpme']."\"></a></td><td class=\"padv\" colspan=\"3\"><input size=\"4\" name=\"timediff\" value=\"0\"></td></tr>
</table>
</form>";
}
...
<form name=\"easyclean\" action=\"./admin_stats.php\" method=\"post\">
...
<form name=\"hardclean\" action=\"./admin_stats.php\" method=\"post\">
...
<form name=\"accesclean\" action=\"./admin_stats.php\" method=\"post\">
...
<form name=\"fullclean\" action=\"./admin_stats.php\" method=\"post\">
</table>\n";
echo "<table align=\"center\">
...
global $strings;
global $lang;
echo "<form name=\"accesclean\" action=\"./admin_stats.php\" method=\"post\">
...
global $strings;
global $lang;
echo "<form name=\"easyclean\" action=\"./admin_stats.php\" method=\"post\">
...
while ($bar=each($sites)) {
	...
	echo "<td align=\"center\" class=\"padv\"><form name=\"erasedata$id\" action=\"./admin_stats.php\" method=\"post\"><input type=\"hidden\" name=\"mode\" value=\"setup\"><input type=\"hidden\" name=\"show\" value=\"erasedata\"><input type=\"hidden\" name=\"lang\" value=\"$lang\"><input type=\"hidden\" name=\"sid\" value=\"$id\"><input type=\"submit\" value=\"".$strings['Submit']."\"></form></td>";
	echo "<td align=\"center\" class=\"padv\"><form name=\"delete$id\" action=\"./admin_stats.php\" method=\"post\"><input type=\"hidden\" name=\"mode\" value=\"setup\"><input type=\"hidden\" name=\"show\" value=\"deletesite\"><input type=\"hidden\" name=\"lang\" value=\"$lang\"><input type=\"hidden\" name=\"sid\" value=\"$id\"><input type=\"submit\" value=\"".$strings['Submit']."\"></form></td>";
	echo "</tr>\n";
}
echo "</table>\n";
}
...
while ($row = mysql_fetch_object($res)) {
	...
	$unblocklink = "<a href=\"admin_stats.php?mode=setup&amp;todo=removebanip&amp;id=$id&amp;lang=$lang\" class=\"basic\">".$strings['unblock']."</a>";
	$str .= "<tr><td>$ip";
...
$str = "<form action=\"./admin_stats.php\" method=\"post\">
...
$str .= "<form name=\"newpwd\" action=\"./admin_stats.php\" method=\"post\"  OnSubmit=\"return validates(this);\">
<table  align=\"center\">
...
$setupitems = array(
$strings['Sitelist'] => "./admin_stats.php?mode=setup&amp;show=sites&amp;lang=$lang",
$strings['Options'] => "./admin_stats.php?mode=setup&amp;show=options&amp;lang=$lang",
$strings['IPban'] => "admin_stats.php?mode=setup&amp;show=baniptable&amp;lang=$lang",
$strings['OSbrowserslist'] => "./admin_stats.php?mode=setup&amp;show=oswb&amp;lang=$lang",
$strings['Searchengineslist'] => "admin_stats.php?mode=setup&amp;show=sebl&amp;lang=$lang",
$strings['Databasecleanup'] => "admin_stats.php?mode=setup&amp;show=testcleanup&amp;lang=$lang",
$strings['Removesite'] => "admin_stats.php?mode=setup&amp;show=testclearsite&amp;lang=$lang",
$strings['RemovePage'] => "./admin_stats.php?mode=setup&amp;show=removepage&amp;lang=$lang",
$strings['SystemTest'] => "./admin_stats.php?mode=setup&amp;show=systemtest&amp;lang=$lang",
$strings['AdminPwd'] => "./admin_stats.php?mode=setup&amp;show=adminpwd&amp;lang=$lang");
