...
<li><a href=\"#\">".$strings['Main']."</a>
	<ul>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;lang=$lang\">".$strings['Summary']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=top&amp;lang=$lang\">".$strings['Top']." ".$display['ntop']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=new&amp;lang=$lang\">".$strings['Newtrends']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=period&amp;interval=day&amp;lang=$lang\">".$strings['Daily']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=period&amp;interval=week&amp;lang=$lang\">".$strings['Weekly']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=period&amp;interval=month&amp;lang=$lang\">".$strings['Monthly']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=page&amp;lang=$lang\">".$strings['Individualpagestatistics']."</a></li>
	</ul></li>
<li><a href=\"#\">".$strings['Who']."</a>
	<ul>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=os&amp;lang=$lang\">".$strings['Operatingsystem']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=browser&amp;lang=$lang\">".$strings['Browser']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=resolution&amp;lang=$lang\">".$strings['Screenresolution']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=country&amp;lang=$lang\">".$strings['Country']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=profile&amp;lang=$lang\">".$strings['Visitorsprofile']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=windows&amp;lang=$lang\">".$strings['Windowsversions']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=labelip&amp;lang=$lang\">".$strings['VisitorsWithLabel']."</a></li>
	</ul></li>
<li><a href=\"#\">".$strings['Sources']."</a>
	<ul>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=entryexit&amp;lang=$lang\">".$strings['Entryexitpages']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=ref&amp;sort=hits&amp;start=1&amp;pageid=all&amp;lang=$lang\">".$strings['Referrers']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=key&amp;lang=$lang\">".$strings['Keywords']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=seplot&amp;lang=$lang\">".$strings['Searchengines']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=kwdplot&amp;lang=$lang\">".$strings['Newkeywordsperday']."</a></li>
	</ul></li>
<li><a href=\"#\">".$strings['Navigation']."</a>
	<ul>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=pathfull&amp;lang=$lang\">".$strings['Pathanalysis']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=duration&amp;lang=$lang\">".$strings['Visitduration']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=retention&amp;lang=$lang\">".$strings['Visitorretention']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=visitstimeday&amp;lang=$lang\">".$strings['VisitsPerHour']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=visitsday&amp;lang=$lang\">".$strings['VisitsPerDay']."</a></li>
	</ul></li>
<li class=\"latest\"><a href=\"#\">".$strings['Latestvisitors']."</a>
	<ul>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=latest&amp;lang=$lang\">".$strings['Details']."</a></li>
		<li><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=path&amp;sort=2&amp;lang=$lang\">".$strings['Path']."</a></li>
	</ul></li>
</ul>
