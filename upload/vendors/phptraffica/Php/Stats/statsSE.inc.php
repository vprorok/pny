...
$arrowsLatest = linksUpDown("./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=key&amp;sort=latest&amp;start=1&amp;pageid=$pageid&amp;lang=$lang&amp;casesensitive=$lowercase&amp;groupengine=$groupengines", $strings['Sortby']." ".$strings['Firsttime'], '');
$arrowsLatesthit = linksUpDown("./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=key&amp;sort=latesthit&amp;start=1&amp;pageid=$pageid&amp;lang=$lang&amp;casesensitive=$lowercase&amp;groupengine=$groupengines", $strings['Sortby']." ".$strings['Latesthit'], '');
$arrowsHits = linksUpDown("./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=key&amp;sort=hits&amp;start=1&amp;pageid=$pageid&amp;lang=$lang&amp;casesensitive=$lowercase&amp;groupengine=$groupengines", $strings['Sortby']." ".$strings['Numberofhits'], '');
$arrowsKey = linksUpDown("./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=key&amp;sort=key&amp;start=1&amp;pageid=$pageid&amp;lang=$lang&amp;casesensitive=$lowercase&amp;groupengine=$groupengines", $strings['Sortby']." ".$strings['Keyword'], '');
...
if ($n == 0) {
	...
	$toreturn .= navPage("./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=key&amp;sort=$sort&amp;order=$order&amp;casesensitive=$lowercase&amp;groupengine=$groupengines&amp;pageid=$pageid&amp;lang=$lang$extralink&amp;start=", $npages, $start);
	$toreturn .= "</div></td></tr>\n";
	$toreturn .= "<tr><td align=\"center\" colspan=\"4\"><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=seplot&amp;pageid=$pageid&amp;lang=$lang\" class=\"basic\">".$strings['Searchengines']."</a> -- <a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=kwdplot&amp;pageid=$pageid&amp;lang=$lang\" class=\"basic\">".$strings['NewkeywordsPday']."</a></td></tr>\n";
}
...
$url = "admin_stats.php?mode=stats&amp;sid=$sid&amp;show=key&amp;lang=$lang";
...
echo "<form method='post' action='admin_stats.php'>
...
$nav = formnavpages($c, $table, $showpage, "admin_stats.php?mode=stats&amp;sid=$sid&amp;show=kwdplot&amp;lang=$lang", $strings['Statisticsfor']);
echo $nav;
if ($showpage=='all') {
...
echo "</td></tr>\n";
echo "<tr><td align=\"center\" width=\"50%\"><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=seplot&amp;pageid=$showpage&amp;lang=$lang\">".$strings['Searchengines']."</a></td><td align=\"center\" class=\"bleft\"><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=key&amp;pageid=$showpage&amp;sort=kwd&amp;start=1&amp;lang=$lang\">".$strings['Keywords']."</a></td></tr>\n";
echo "</table>\n";
}
...
$nav = formnavpages($c, $table, $showpage, "admin_stats.php?mode=stats&amp;sid=$sid&amp;show=seplot&amp;lang=$lang", $strings['Statisticsfor']);
echo $nav;
if ($showpage=='all') {
...
echo "</td></tr>\n";
echo "<tr><td align=\"center\" width=\"50%\"><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=kwdplot&amp;pageid=$showpage&amp;lang=$lang\">".$strings['NewkeywordsPday']."</a></td><td align=\"center\" class=\"bleft\"><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=key&amp;pageid=$showpage&amp;sort=kwd&amp;start=1&amp;lang=$lang\">".$strings['Keywords']."</a></td></tr>\n";
echo "</table>\n";
}
