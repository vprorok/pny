...
<tr><td>
<form name=\"previousperiod\" action=\"admin_stats.php?mode=stats&amp;sid=$sid&amp;lang=$lang\" method=\"post\">
...
<input type=\"image\" src=\"img/phptraffica/System/back.png\" height=\"24\" width=\"24\" border=\"0\" ALT=\"".$strings['Previous']."\">
</form>
</td><td>
<form name=\"dateselect\" action=\"admin_stats.php?mode=stats&amp;sid=$sid&amp;lang=$lang\" method=\"post\">
<input type=\"hidden\" name=\"show\" value=\"period\">
...
<td><form name=\"previousperiod\" action=\"admin_stats.php?mode=stats&amp;sid=$sid&amp;lang=$lang\" method=\"post\">
<input type=\"hidden\" name=\"show\" value=\"period\">
<input type=\"hidden\" name=\"interval\" value=\"$interval\">
...
<input type=\"image\" src=\"img/phptraffica/System/forward.png\" height=\"24\" width=\"24\" border=\"0\" ALT=\"".$strings['Next']."\">
</form></td>
</tr></table>\n";
...
$txtPage = linksUpDown("./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=period&amp;interval=$interval&amp;enddate=$enddatecall&amp;lang=$lang&amp;sort=name", $strings['Sortby']." ".$strings['Name'], "#tablePages");
$txtHits = linksUpDown("./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=period&amp;interval=$interval&amp;enddate=$enddatecall&amp;lang=$lang&amp;sort=hits", $strings['Sortby']." ".$strings['Hits'], "#tablePages");
$txtHitsPc = linksUpDown("./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=period&amp;interval=$interval&amp;enddate=$enddatecall&amp;lang=$lang&amp;sort=hitspc", $strings['Sortby']." %","#tablePages");
$txtVisits = linksUpDown("./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=period&amp;interval=$interval&amp;enddate=$enddatecall&amp;lang=$lang&amp;sort=visits", $strings['Sortby']."   ".$strings['Visits'],"#tablePages");
$txtVisitsPc = linksUpDown("./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=period&amp;interval=$interval&amp;enddate=$enddatecall&amp;lang=$lang&amp;sort=visitspc", $strings['Sortby']." %","#tablePages");
