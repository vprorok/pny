...
$str .= "</td></tr>";
$link0 = "<a href=\"admin_stats.php?mode=stats&amp;sid=$sid&amp;show=page&amp;lang=$lang&amp;pathid=".$patharray[0]."\" class=\"basic\">".$strings['Moreinfo']."</a>";
$link1 = "";
if ((!$wantfirst) &&  ($totalvisitsstart>0)) $link1 = "<a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=pathdesign&amp;lang=$lang&amp;pathid=0|$pathid\" class=\"basic\">".$strings['Addtopath']."</a>";
...
while($row = mysql_fetch_object($res)) {
	...
	$link1 = "<a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=pathdesign&amp;lang=$lang&amp;pathid=$previous|$pathid\" class=\"basic\">".$strings['Addtopath']."</a>";
	$link2 = "<a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=pathdesign&amp;lang=$lang&amp;pathid=$previous\" class=\"basic\">".$strings['Centerhere']."</a>";
...
foreach ($patharray as $page) {
	...
	$link2 = "<a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=pathdesign&amp;pathid=$page&amp;lang=$lang\" class=\"basic\">".$strings['Centerhere']."</a>";
...
$str .= "<table><tr><td><b>".$strings['Outsideworld']."</b><br> $totalvisitsend ".$strings['visitors']."</td></tr></table>\n";
	...
	if ($totalvisitsend > 0) {
		$link1 = "<a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=pathdesign&amp;lang=$lang&amp;pathid=$pathid|0\" class=\"basic\">".$strings['Addtopath']."</a>";
	} else {
		$link1 = "";
	}
...
while($row = mysql_fetch_object($res)) {
	...
	$link1 = "<a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=pathdesign&amp;lang=$lang&amp;pathid=$pathid|$next\" class=\"basic\">".$strings['Addtopath']."</a>";
	$link2 = "<a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=pathdesign&amp;lang=$lang&amp;pathid=$next\" class=\"basic\">".$strings['Centerhere']."</a>";
	$str .= "<table><tr><td colspan=\"2\">$pagename<br>".visitors($thistotal)." ($pc%)</td></tr><tr><td>$link1</td><td>$link2</td></tr></table>\n";
}
if (!$wantlast) {
	$rest = $totalvisitspage - $total;
...
if ($wantfirst) {
	...
	$str .= "<tr class=\"vflow\"><td colspan=\"2\">&nbsp;</td><td colspan=\"2\"><div  class=\"postit\">".$strings['searchenginesreferrersbookmarks']."<br>".visitors($start)." ($pc1 %)</div></td><td colspan=\"2\">&nbsp;</td></tr>\n<tr class=\"vflow\"><td colspan=\"2\">&nbsp;</td><td align=\"center\" colspan=\"2\"><img src=\"img/phptraffica/System/arrowD.jpg\" width=\"$w1\" height=\"$heightTD\" alt=\"".visitors($start)."\"></td><td colspan=\"2\">&nbsp;</td></tr>\n";
	...
	$str .= "<tr class=\"vflow\"><td colspan=\"2\">&nbsp;</td><td><div class=\"postit\">".$strings['searchenginesreferrersbookmarks']."<br>".visitors($start)." ($pc1 %)</div></td><td><div class=\"postit\">".$strings['Within']." $site<br>".visitors($elsewhere)." ($pc2 %)</div></td><td colspan=\"2\">&nbsp;</td></tr>\n<tr class=\"vflow\"><td colspan=\"2\">&nbsp;</td><td align=\"center\"><img src=\"img/phptraffica/System/arrowD.jpg\" width=\"$w1\" height=\"$heightTD\" alt=\"".visitors($start)."\"></td><td align=\"center\"><img src=\"img/phptraffica/System/arrowD.jpg\" width=\"$w2\" height=\"$heightTD\" alt=\"".visitors($elsewhere)."\"></td><td colspan=\"2\">&nbsp;</td></tr>\n";
	// number of visits that stop here
	$length = strlen($path);
	$sql = "SELECT SUM(count) as count FROM ${table}_path WHERE INSTR(path,'$path')>0 and SUBSTRING_INDEX(SUBSTRING(path,INSTR(path,'$path')+$length),'|',1)='' $extrasql";
	$res = mysql_query($sql,$c);
...
while ($id = next($patharray)) {
	...
	$str .= "<tr class=\"vflow\"><td><div class=\"postit\">".$strings['Endofvisit']."<br>".visitors($stop)." ($pc1 %)</div></td><td valign=\"middle\" align=\"right\"><img src=\"img/phptraffica/System/arrowL.jpg\" width=\"$widthLR\" height=\"$h1\" alt=\"".visitors($stop)."\"></td>";
	...
	$str .= "<td valign=\"middle\" align=\"left\"><img src=\"img/phptraffica/System/arrowR.jpg\" width=\"$widthLR\" height=\"$h2\" alt=\"".visitors($elsewhere)."\"></td><td><div class=\"postit\">".$strings['Somewhereelseon']." $site<br>".visitors($elsewhere)." ($pc1 %)</div></td></tr>\n";
	// number of visits that stop here
	$length = strlen($path);
	$sql = "SELECT SUM(count) as count FROM ${table}_path WHERE INSTR(path,'$path')>0 and SUBSTRING_INDEX(SUBSTRING(path,INSTR(path,'$path')+$length),'|',1)='' $extrasql";
	$res = mysql_query($sql,$c);
	...
	$str .= "<tr class=\"vflow\"><td colspan=\"2\">&nbsp;</td><td align=\"center\"  colspan=\"2\"><img src=\"img/phptraffica/System/arrowD.jpg\" width=\"$w1\" height=\"$heightTD\" alt=\"".visitors($come)."\"></td><td colspan=\"2\">&nbsp;</td></tr>\n";
	$oldid = $id;
}
...
$pc1 = format_float($stop/$totalvisits*100.,1);
$pc2 = format_float($elsewhere/$totalvisits*100.,1);
$str .= "<tr class=\"vflow\"><td colspan=\"2\">&nbsp;</td><td align=\"center\"><img src=\"img/phptraffica/System/arrowD.jpg\" width=\"$w1\" height=\"$heightTD\" alt=\"".visitors($stop)."\"></td><td align=\"center\"><img src=\"img/phptraffica/System/arrowD.jpg\" width=\"$w2\" height=\"$heightTD\"  alt=\"".visitors($elsewhere)."\"></td><td colspan=\"2\">&nbsp;</td></tr>\n<tr class=\"vflow\"><td colspan=\"2\">&nbsp;</td><td><div class=\"postit\">".$strings['Endofvisit']."<br>".visitors($stop)." ($pc1 %)</div></td><td><div class=\"postit\">".$strings['Stayon']." $site<br>".visitors($elsewhere)." ($pc2 %)</div></td><td colspan=\"2\">&nbsp;</td></tr>\n";
//
$str .= "</table>\n";
echo $str;
}
...
while($row = mysql_fetch_object($res)) {
	...
	foreach ($patharray as $page) {
		if ($old != $page) {
			if ($old != 0) {
				...
				$link = "<a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=pathdesign&amp;lang=$lang&amp;pathid=$page\" class=\"basic\">".$strings['Centerhere']."</a>";
	...
	$str .= "<div class=\"clearer\">&nbsp;</div><div align=\"right\"><a href=\"./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=studypath&amp;lang=$lang&amp;pathid=$pathid\" class=\"basic\">".$strings['Studyvisitorsflowalongthispath']."</a></div></td></tr>";
}
$str .= "</table>";
echo $str;
}
