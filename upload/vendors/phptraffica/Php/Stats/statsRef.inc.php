...
$link = "./admin_stats.php?mode=followref&amp;sid=$sid&amp;id=$refID";
$url=cleanURL($url);
...
// Page navigation
// echo formnavpages($c,$table,$pageid,"admin_stats.php?mode=stats&amp;sid=$sid&amp;show=ref&amp;sort=hits&amp;start=1&amp;lang=$lang",$strings['Statisticsfor'], true);
$select = selectnavpages($c, $table, $pageid);
$url = "admin_stats.php?mode=stats&amp;sid=$sid&amp;show=ref&amp;sort=hits&amp;start=1&amp;lang=$lang";
...
$arrowsLatest = linksUpDown("./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=ref&amp;sort=latest&amp;start=1&amp;pageid=$pageid&amp;onlynew=$onlynew&amp;lang=$lang$searchURL", $strings['Sortby']." ".$strings['Latesthit'], '');
$arrowsFirst = linksUpDown("./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=ref&amp;sort=added&amp;start=1&amp;pageid=$pageid&amp;onlynew=$onlynew&amp;lang=$lang$searchURL", $strings['Sortby']." ".$strings['Latests'], '');
$arrowsHits = linksUpDown("./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=ref&amp;sort=hits&amp;start=1&amp;pageid=$pageid&amp;onlynew=$onlynew&amp;lang=$lang$searchURL", $strings['Sortby']." ".$strings['Numberofhits'], '');
$arrowsRefs = linksUpDown("./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=ref&amp;sort=refs&amp;start=1&amp;pageid=$pageid&amp;onlynew=$onlynew&amp;lang=$lang$searchURL", $strings['Sortby']." ".$strings['Numberofhits'], '');
...
if ($n == 0) {
	...
	echo navPage("./admin_stats.php?mode=stats&amp;sid=$sid&amp;show=ref&amp;sort=$sort&amp;order=$order&amp;pageid=$pageid&amp;onlynew=$onlynew&amp;lang=$lang$searchURL&amp;start=", $npages, $start);
	echo "</div></td></tr>\n";
}
echo "</table>\n";

// Search tables
echo "<form method='get' action='admin_stats.php'>
